...
- Aligned `CITATION.cff` and `.zenodo.json` with release `v2.5.8`

## [2.5.7] - 2026-09-05

### Documentation

- Enriched `CITATION.cff` with complete software metadata and the preferred manuscript citation
...
- Simplified `CITATION.cff` to the CFF 1.1.0 format expected by Zenodo
