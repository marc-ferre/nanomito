...
### HTML Report Archiving with Integrity Verification

- [x] **HTML report archiving to project storage** ✅ COMPLETED
  - ✅ Reports generated by wf-finalize.sh now archived to `/projects/nanomito/<RUN_ID>/processing`
  - ✅ SHA256 checksum file created during archiving (`reports_checksum.<RUN_ID>.txt`)
  - ✅ Archiving happens AFTER report generation (solves previous ordering issue)
  - ✅ Per-sample report directory structure preserved in archive
  - ✅ Tested and validated on Genouest HPC (run 240619)

- [x] **Report integrity verification** ✅ COMPLETED
  - ✅ Automatic SHA256 checksum validation before email notification
  - ✅ Clear log messages on success/failure of archiving
  - ✅ Checksum file stored with reports for post-execution audits
  - ✅ All 4 reports (1 global + 3 per-sample) verified successfully
